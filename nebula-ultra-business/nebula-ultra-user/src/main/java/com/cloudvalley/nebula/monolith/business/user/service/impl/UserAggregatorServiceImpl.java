...
import com.cloudvalley.nebula.monolith.shared.api.dept.service.IDeptTenantCommonService;
import com.cloudvalley.nebula.monolith.shared.api.dept.service.IDeptUserCommonService;
import com.cloudvalley.nebula.monolith.shared.api.dept.service.ISysDeptCommonService;
...
import com.cloudvalley.nebula.monolith.shared.api.role.service.IRoleTenantCommonService;
import com.cloudvalley.nebula.monolith.shared.api.role.service.IRoleUserCommonService;
import com.cloudvalley.nebula.monolith.shared.api.role.service.ISysRoleCommonService;
import com.cloudvalley.nebula.monolith.shared.api.tenant.model.vo.SysTenantVO;
import com.cloudvalley.nebula.monolith.shared.api.tenant.service.ISysTenantCommonService;
...
import com.cloudvalley.nebula.monolith.shared.api.user.service.IUserTenantCommonService;
...
public class UserAggregatorServiceImpl implements IUserAggregatorService {
    ...
    public SysUserVO login(String username, String passwordHash) {
        ...
        // 3. 登录成功(用户信息不为空) 根据用户Id 查询 用户租户Id

        // 4. 根据 用户租户Id 查询 绑定 租户部门Id

        // 5. 根据 租户部门Id 查询 绑定 部门信息

        // 6. 根据 租户部门Id 查询 绑定 租户权限Id

        // 7. 根据 用户租户Id 查询 绑定 租户角色Id

        // 8. 根据 租户角色Id 获取 角色信息

        // 9. 根据 租户角色Id 查询 绑定 租户权限Id

        // 10. 根据 租户用户Id 获取 绑定 租户权限Id

        // 11. 根据 租户权限Id 获取 系统权限Id

        // 12. 根据 系统权限Id 获取 系统权限信息

        // 13. 权限状态 判定 级别 系统 > 租户 > 部门 > 角色 > 用户 返回Map<权限状态:层级 权限Id>
